                    ...
                    {categories.map((cat, i) => (
                        ...
                        >
                            <Link
                                ...
                                className="group relative block w-full h-[60vh] md:h-[50vh] overflow-hidden rounded-sm border border-white/5 bg-[#050505] hover:border-white/10 transition-all duration-700"
                            >
                                ...
                                <div className="absolute inset-0 flex flex-col justify-center p-8 md:p-16 z-10">
                                    <div className="max-w-xl">
                                        <span className="text-[10px] font-medium tracking-[0.3em] text-accent/60 uppercase block mb-6 transition-transform duration-700 group-hover:-translate-y-1">
                                            {cat.subtext}
                                        </span>
                                        <h3 className="text-4xl md:text-6xl font-display font-light text-white mb-6 tracking-tight leading-tight">
                                            {cat.title}
                                        </h3>
                                        <p className="text-sm md:text-base text-text-dim leading-relaxed mb-10 max-w-md font-light group-hover:text-white/70 transition-colors">
                                            {cat.descriptor}
                                        </p>

                                        {/* Action */}
                                        <div className="flex items-center gap-4 group/action">
                                            <span className="text-[10px] font-medium tracking-[0.25em] text-white/40 uppercase group-hover/action:text-accent transition-colors">
                                                Explore Room
                                            </span>
